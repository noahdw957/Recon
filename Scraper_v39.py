...
# ============================================================
# RECON LIVE BUY SCANNER V3.9 - SAME-DAY BUY PERSISTENCE + PROJECTED PEAK
#
# USER-FACING OUTPUT:
#     buy_tickers.txt
#
...
SCANNER_VERSION = "RECON_LIVE_V3.9_SAME_DAY_BUY_PERSISTENCE"
...
def format_consumer_buy_line(ticker, projection):
    if projection is not None and pd.notna(projection):
        return f"{ticker} BUY | PROJECTED 90D PEAK {float(projection):+.0f}%\n"
    return f"{ticker} BUY | PROJECTED 90D PEAK N/A\n"
